...
// LR1121 is the 2.4 GHz-capable member of the LR11x0 family. It shares the LR11x0
// driver with the LR1110/LR1120, but its setFrequency() accepts the 2400-2500 MHz
// band and it can run the wide (812.5 kHz) "high" bandwidth. Board-specific 2.4 GHz
// setup (high-mode begin + RF switch table) lives in the variant's target.cpp.
